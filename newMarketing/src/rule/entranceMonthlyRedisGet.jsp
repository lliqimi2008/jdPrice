...
<div id="modelDiv" class="jumbotron" style="width:800px">
    ...
    <div class="control-group">
        <span>规则说明：</span>
        <label class="control-label" id="modelDesc">用户维度限制用户每月参与子活动活动的次数，直接与缓存数据对比，不进行库查询，效率较高</label>
...
<script type="text/javascript">
    ...
    function addRowBefore() {
        ...
        prizeOverlay = "Y";
        status = "0";
        var selectElement = document.getElementById("modelLimitType");
        var selectIndex = selectElement.selectedIndex;
        calType = selectElement.options[selectIndex].value;
