...
<div id="modelDiv" class="jumbotron col-md-4">
    ...
    <div class="control-group">
        <span>规则说明：</span><label class="control-label" id="modelRuleDesc">用户标签规则</label>
    </div>
    ...
    <div class="control-group" style="margin-top: 10px">
        人群Id：：<textarea rows="3" cols="20" id="modelCalValue" placeholder="如有多值，用竖线分割"/>
    </div>
...
<script type="text/javascript">
    ...
    function setExtension() {
        ...
        extension = "{\"ruleIds\":\"" + value + "\",\"compareType\":\"userTagNotAllIn\"}";
