...
<div id="modelDiv" class="jumbotron" style="width:800px">
    ...
    <div class="control-group">
        <span>规则说明：</span>
        <label class="control-label" id="modelDesc">判断银行卡是否为小白卡</label>

    </div>
    <div class="control-group">
        <span>限制类型：</span>
        <select id="modelCalValue" style="height: 25px;width: 130px">
            <option value="Y">限小白卡参加</option>
            <option value="N">限小白卡不能参加</option>
        </select>
    </div>
...
<script type="text/javascript">
    ...
    function addRowBefore() {
       // ruleType = "03";
        ...
        status = "0";
        calType = "==";
        calValue = getSelectById("modelCalValue");
        extension = "";
        noPassDesc = "";
        //调用create页新增行
        addRow();
