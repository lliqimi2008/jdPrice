...
<div id="modelDiv" class="jumbotron" style="width:800px">
    ...
    <div class="control-group">
        <span>规则说明：</span>
        <label class="control-label" id="modelDesc">用户交易金额月限制</label>
    ...
    <div class="control-group" style="margin-top: 10px">
        ...
        <input type="text" id="modelCalValue" style="height: 25px;width: 130px" placeholder="金额（分）"/>
    </div>
    <div class="control-group" style="margin-top: 10px">
        <span>主活动ID:</span>&nbsp;&nbsp;
        <input type="text" id="modelID" style="height: 25px;width: 265px"/>
    </div>
...
<script type="text/javascript">
    ...
    function addRowBefore() {
        ...
        extension = document.getElementById("modelID").value;
        //调用create页新增行
        addRow();
    }
