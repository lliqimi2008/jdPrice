      ...
      <el-form
        ...
        <el-row>
          ...
          <el-col :span="3" :offset="1">
              <el-button  size="small" type="primary" @click="searchSpecificData" v-hasPermissions="'marketingApproveManage:bpmList:searchBtn'">查询</el-button>
          </el-col>
        </el-row>
      </el-form>
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button
              ...
              type="text"
              @click="handleViewActual(scope.row.id)" v-hasPermissions="'marketingApproveManage:bpmList:tracking'">跟踪</el-button>
            <el-button
              size="mini"
              type="text"
