<template>
  <div class="activity-detail">
    <div class="pub-sm-title clear">
      <h3 class="fl">活动详情</h3>
      <el-row class="fr">
        <!--<el-button size="mini" type="primary" @click="editActivity">编辑</el-button>-->
    ...
    <div class="pv bg-pad-border">
      ...
      <el-row>
        <el-col :span="12"><strong>业务标识：</strong>{{data.bizType}}</el-col>
      ...
      <el-row>
        ...
        <el-col :span="12"><strong>退款是否恢复用户参与资格：</strong>{{data.recoverRefunding ? (data.recoverRefunding === true ? '是' : '否') : ''}}</el-col>
