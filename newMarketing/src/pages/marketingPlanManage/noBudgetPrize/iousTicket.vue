    ...
    <div>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px" class="demo-ruleForm">
        ...
        <el-form-item label="token" prop="prizeToken">
          <el-input v-model="form.prizeToken" placeholder="请输入 token"></el-input>
        </el-form-item><el-form-item label="白条优惠券ID" prop="baitiaoCouponKey">
          <el-input v-model="form.baitiaoCouponKey" placeholder="请输入白条优惠券ID"></el-input>
        </el-form-item>
      ...
      if (prizeId) {
        ...
        newBudgetSearchDetail(params)
          .then(res => {
            ...
            this.form.baitiaoCouponKey = data.baitiaoCouponKey
        ...
        this.$refs[form].validate((valid) => {
          if (!valid) {
            ...
            let reqParams = {
              ...
              interType: 'BAI_TIAO',
              baitiaoCouponKey: this.form.baitiaoCouponKey,
