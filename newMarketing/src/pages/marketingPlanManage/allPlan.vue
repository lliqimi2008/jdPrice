<template>
  <section class="all-plan-section">
    <el-tabs v-model="activeTabName"
      @tab-click="planTabClick">
      <el-tab-pane label="营销计划总览" v-hasPermissions="'marketingPlanManage:allPlan'" name="second">
        <div class="pub-sm-title clear">
          <h3 class="fl">营销计划管理</h3>
          <div class="fr">
      ...
      <el-tab-pane label="营销活动总览" v-hasPermissions="'marketingPlanManage:allPlan'" name="first">
        <div class="pub-sm-title clear">
          <h3 class="fl">营销活动总览</h3>
        </div>

        <div class="content-body1">
          <div class="total-activity-pandect">
            <div v-if="totalActivityList.length === 0" class="totalActivityListNone">暂无数据</div>
            <div class="pandect-item" v-for="item in totalActivityList" :key="item.name">
              <div class="pandect-item-header">{{item.activityCount}}</div>
              <div class="pandect-item-body">{{item.activityTypeName}}</div>
            </div>
          </div>
          ...
          <el-form
            ...
            label-width="120px"
            size="small"
            ref="searchActivityObj"
            :rules="searchActivityObjRules"
            :model="searchActivityObj">

            <el-row>
              <el-col :span="8">
                <el-form-item label="活动计划部门：" prop="planDepartment">
                  <el-select class="select100" v-model="searchActivityObj.planDepartment" placeholder="请选择">
                    <el-option
                      v-for="item in searchActivityObj.departmentsOptions"
                      :key="item.value"
                      :label="item.label"
                      :value="item.value">
                    </el-option>
              ...
              <el-col :span="8">
                <el-form-item label="活动状态：" prop="activityStatus">
                  <el-select class="select100" v-model="searchActivityObj.activityStatus" placeholder="请选择" size="small">
                    <el-option
                      v-for="item in searchActivityObj.statusOptions"
                      :key="item.value"
                      :label="item.label"
                      :value="item.value">
                    </el-option>
              ...
              <el-col :span="8">
                <el-form-item label="商户号：" prop="merchantNo">
                  <el-input v-model="searchActivityObj.merchantNo" placeholder="请输入商户号"></el-input>
                </el-form-item>
              </el-col>

              <el-col :span="8">
                <el-form-item label="创建人：" prop="creator">
                  <el-input v-model="searchActivityObj.creator" placeholder="请输入创建人"></el-input>
                </el-form-item>
              </el-col>

              <el-col :span="8">
                <el-form-item label="营销计划ID：" prop="planId">
                  <el-input v-model="searchActivityObj.planId" placeholder="请输入营销计划ID"></el-input>
                </el-form-item>
              </el-col>

              <el-col :span="5">
                <el-form-item label="">
                  <el-button type="primary" @click="handleSearchActivity">查询</el-button>
                </el-form-item>
              </el-col>
            </el-row>
          ...
          <div class="echarts clear">
            <template v-if="activityList.length">
              <chart :options="echartOption"></chart>
            </template>
          </div>
          ...
          <div class="pagination">
            <el-pagination
              ...
              :current-page="1"
              :page-size="10"
              :total="searchActivityObj.activityTotal">
            </el-pagination>
          </div>
          ...
          <div class="table-content">
            <el-table
              ...
              <el-table-column
                ...
                align="center">
                <template slot-scope="scope">
                  <p>{{activityStatusFormat(scope.row.activityStatus, scope.row.startTime, scope.row.offlineTime || scope.row.endTime)}}</p>
                </template>
              </el-table-column>
              <el-table-column
                prop="creator"
              ...
              <el-table-column
                ...
                align="center">
                <template slot-scope="scope">
                  <p>{{ scope.row.offlineTime || scope.row.endTime | formatDate('YYYY-MM-DD hh:mm:ss') }}</p>
                </template>
              </el-table-column>
            </el-table>
          </div>
  ...
  methods: {
    ...
    handleSearchMarket() {
      ...
      let reqParams = {
        ...
        creator: this.searchMarketObj.creator,
