      ...
      <el-form
        ...
        <el-col :span="7">
          <el-form-item label="礼包id" prop="prizeId">
            <el-input v-model="associatedPrize.prizeId" placeholder="礼包id" size="mini" class="w100"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="7">
          <el-form-item label="礼包名称">
            <el-input v-model="associatedPrize.prizeName" placeholder="礼包名称" size="mini" class="w100"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="3">
          <el-form-item>
