  ...
  <el-form class="app-form-panel"
    ...
    <el-form-item label="用户类型"  prop="calValue">
      <el-radio-group v-model="ruleForm.calValue">
        <el-radio label="true">黄金新用户</el-radio>
        <el-radio label="false">非黄金新用户</el-radio>
      </el-radio-group>
    </el-form-item>


    <el-form-item label="错误文案描述：" prop="noPassDesc">
      <el-input v-model="ruleForm.noPassDesc" placeholder="非活动指定的黄金用户" size="small"></el-input>
    </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      ruleForm: {
        ruleName: '黄金用户类型',
        instructions: '限制参加活动的黄金用户类型',
        noPassDesc: '非活动指定的黄金用户'
      },
      ruleFormRules: {
        calValue: [
          {
