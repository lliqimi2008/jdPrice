<template>
  <el-form class="app-form-panel"
    ...
    ref="ruleForm" :model="ruleForm" :rules="ruleFormRules">
      ...
      <el-form-item label="银行卡类型:" prop="types">
        <el-checkbox-group v-model="ruleForm.types">
          <el-checkbox label="1002" name="types">借记卡</el-checkbox>
          <el-checkbox label="1001" name="types">贷记卡</el-checkbox>
        </el-checkbox-group>
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      ruleForm: {
        ruleName: '银行卡类型',
        instructions: '限制使用的银行卡类型',
        types: [],
        noPassDesc: '非指定可参与活动的银行卡类型'
      },
      // 保存规则数据
      requestRelesData: {
        // 规则类型
