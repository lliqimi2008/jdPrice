...
export default {
  ...
  data() {
    return {
      ...
      ruleForm: {
        calType: '>=',
        ruleName: '商城订单所属店铺ID限制',
        instructions: '对商城订单所属的店铺ID进行相应限制',
        noPassDesc: '订单中含有非活动店铺商品',
        // 限制类型
        limitType: 'shopIdAllIn',
        limitTypes: [
          {
            label: '全部商品属于以下店铺',
            value: 'shopIdAllIn'
  ...
  methods: {
    editDefaultVal(data) {
      ...
      this.ruleForm.limitType = keys[0] || 'shopIdAllIn'
