<template>
  <el-form class="app-form-panel"
    ...
    ref="ruleForm" :model="ruleForm" :rules="ruleFormRules">
      ...
      <el-form-item label="PI：" prop="types">
        <el-checkbox-group v-model="ruleForm.types">
          <el-checkbox label="ExpressCardPI" name="types">快捷银行卡支付</el-checkbox>
          <el-checkbox label="XjkPI" name="types">小金库</el-checkbox>
          <el-checkbox label="JCaiPI" name="types">金采</el-checkbox>
          <el-checkbox label="JIOUPI" name="types">打白条(白条不分期+白条分期)</el-checkbox>
          <el-checkbox label="JIOU2PI" name="types">白条不分期</el-checkbox>
          <el-checkbox label="JIOU3PI" name="types">白条分期</el-checkbox>
        </el-checkbox-group>
      </el-form-item>
