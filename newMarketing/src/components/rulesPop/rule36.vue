    ...
    ref="ruleForm" :model="ruleForm" :rules="ruleFormRules">
      ...
      <el-form-item label="会员类型：" prop="calValue">
        <el-radio-group v-model="ruleForm.calValue">
          <el-radio label="1">校园白条</el-radio>
          <el-radio label="2">普通白条</el-radio>
          <el-radio label="0">非白条</el-radio>
        </el-radio-group>
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      butDisabled: false,
      name: 'baiTiaoUserLimit',
      ruleCodeName: 'rule36',
      ruleForm: {
        ruleName: '白条用户分类',
        instructions: '选择可参加活动的白条用户',
        noPassDesc: '非活动指定的白条用户类型'
      },
      // 保存规则数据
      requestRelesData: {
        // 规则类型
